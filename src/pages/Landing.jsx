...
export default function Landing() {
  ...
  return (
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, Inter, sans-serif', overflowX: 'hidden' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '800px' }}>
          ...
          <div style={{
            ...
            {['AES-256 Encrypted', 'Instant Upload', 'Auto Delete', 'AWS Powered'].map(badge => (
              <span key={badge} style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)' }}>
                {badge}
              </span>
            ))}
          </div>
      ...
      {/* Stats */}
      <div ref={statsRef} style={{ background: 'white', padding: '60px 24px', textAlign: 'center' }}>
        <div style={{
          maxWidth: '800px', margin: '0 auto',
          display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '40px'
        }}>
          {[
            { value: count1, suffix: '+',   label: 'Files Shared',      color: '#4f46e5' },
            { value: count2, suffix: '-bit', label: 'Encryption Key',   color: '#7c3aed' },
            { value: count3, suffix: '.9%', label: 'Uptime Guarantee',  color: '#10b981' },
          ].map(stat => (
            <div key={stat.label}>
              <div style={{
                fontSize: '48px', fontWeight: '900',
                color: stat.color, margin: '0 0 6px', letterSpacing: '-2px'
              }}>
      ...
      {/* Footer */}
      <div style={{
        background: '#0f172a', padding: '24px', textAlign: 'center',
